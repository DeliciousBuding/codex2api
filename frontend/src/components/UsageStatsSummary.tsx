...
import { Activity, BarChart3, Clock, Gauge, Zap } from 'lucide-react'
      ...
      <CardContent className="p-4">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          ...
          <MetricGroup
            ...
            primaryValue={formatPercent(stats.today_cache_rate)}
          >
            <MetricLine label={t('dashboard.todayCachedTokens')} value={formatInteger(stats.today_cached_tokens, locale)} />
            <MetricLine label={t('dashboard.totalCacheHitRate')} value={formatPercent(stats.total_cache_rate)} />
          </MetricGroup>
